...
$(document).ready(function() {
    ...
    const decount = function(i) {
        ...
        $('#start').on('click', function() { //to restart without reload the page BUT I had an issue, it is like the timer that I stop continue to decrease and when I press #start button, the both counting play et the same time, I gave up because it's midhight, after a lot of hours to try I can't be focus
            time = 0;
            userScore = 0;
